System.register(["aurelia-framework", "./authorization-service"], function (exports_1, context_1) {
    ...
    var aurelia_framework_1, authorization_service_1, GlobalPermissionEnable;
    return {
        setters: [
        ...
        execute: function () {
            GlobalPermissionEnable = (function () {
            ...
            exports_1("GlobalPermissionEnable", GlobalPermissionEnable);
        }
    };
});
