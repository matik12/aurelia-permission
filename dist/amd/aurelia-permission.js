define(["require", "exports", "aurelia-router", "./permission-store", "./authorize-route-step", "./authorization-service", "./global-permission-show", "./global-permission-enable", "./global-permission-if", "./global-permission-else", "./permission-filter"], function (require, exports, aurelia_router_1, permission_store_1, authorize_route_step_1, authorization_service_1, global_permission_show_1, global_permission_enable_1, global_permission_if_1, global_permission_else_1, permission_filter_1) {
    "use strict";
